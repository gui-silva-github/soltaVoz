	...
	<div class="row pt-2">
		...
		<div class="col-md-6">
			<div class="row mb-2">
				<div class="col tweetBox">
					<form method="POST" action="/solta_voz/tweet">
					...
					<div class="col">
						...
						<?php if($tweet['id_usuario'] == $_SESSION['id']) { ?>
								...
								<div class="col d-flex justify-content-end">
									<a href="/solta_voz/acao?acao=remover&id_tweet=<?=$tweet['id']?>" class="btn btn-danger"><small>Remover</small></a>
								</div>
		...
		<div class="col-md-3">
			<div class="quemSeguir">
				...
				<hr />
				<a href="/solta_voz/quem_seguir" class="quemSeguirTxt">Procurar por pessoas conhecidas</a>
			</div>
		</div>
